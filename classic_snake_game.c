...
void exitgame()
{
    ...
    for(q=0;q<8;q++)
    {
        ...
        printf("----------------");
        gotoxy((wd-31),(6));
        printf("SUYASH JAISWAL - A91005219116, ASET, AMITY UNIVERSITY KOLKATA.");
        gotoxy((wd-31),(7));
        printf("VALENTINA ROY  - A91005219117, ASET, AMITY UNIVERSITY KOLKATA.");
        gotoxy((wd-31),(8));
        printf("KASHIS JAISWAL - A91005219118, ASET, AMITY UNIVERSITY KOLKATA.");
        gotoxy((wd-31),(9));
        printf("FAIZAN AHMAD   - A91005219119, ASET, AMITY UNIVERSITY KOLKATA.");
        gotoxy((wd-31),(10));
        printf("ARKA ADHYA     - A91005219121, ASET, AMITY UNIVERSITY KOLKATA.");
        gotoxy((wd-21),(ht-1));
        printf("------------------------------------------ ");
        gotoxy((wd-22),(ht));
...
int record()
{
    ...
    //**************************
    fprintf(info,"  Score:%d\n",px=Scoreonly(score));//call score to display score
...
int main()
{
    ...
    do
    {
        ...
        printf("\n\n\t\t  Press R/r to see past records.");
        printf("\n\n\t\t  Press any other key to EXIT..");
        printf("\n\n\t\t  HighScores of each level : ");
        printf("\n\t\t                              1. BEGINNER      : %d",a[0]);
        printf("\n\t\t                              2. BASIC         : %d",a[1]);
        printf("\n\t\t                              3. INTERMEDIATE  : %d",a[2]);
        printf("\n\t\t                              4. ADVANCED      : %d",a[3]);
        ...
        switch(choice)
        {
        	...
        	case 'R':
        	case 'r':
        		val=MessageBox(hWnd,"VIEWING SCORE ...\nPLEASE WAIT","SCORE",MB_ICONQUESTION |MB_OK);
        		system("cls");
